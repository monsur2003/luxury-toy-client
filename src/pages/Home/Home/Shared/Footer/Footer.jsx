...
const Footer = () => {
   return (
      <>
         <div className="w-full border-t bg-[#101010  ] lg:px-12  py-16 xl:px-20  sm:px-6 px-4">
            <div className="grid  grid-cols-2  md:grid-cols-3  xl:grid-cols-4 md:gap-8 gap-4">
               <div className="flex flex-col flex-shrink-0">
                  ...
                  <p className="text-sm leading-none text-white poppin mt-4">
                     Copyright © 2022 Teddy land
                  </p>
                  <p className="text-sm text-white poppin leading-none mt-4">
                     All rights reserved
                  </p>
               ...
               <div className="sm:ml-0 ml-8">
                  <h2 className="text-base font-semibold leading-4 tracking-widest lilita">
                     Company
                  </h2>
                  <p className="hover:text-gray-500 text-base leading-4 mt-6 text-[14px] text-white poppin cursor-pointer">
                     Blog
                  </p>
                  <p className="hover:text-gray-500 text-base leading-4 mt-6 text-[14px] text-white poppin cursor-pointer">
                     Pricing
               ...
               <div>
                  ...
                  <p className="hover:text-gray-500 text-base leading-4 mt-6 text-white poppin text-[14px] cursor-pointer">
                     Legal policy
                  </p>
                  <p className="hover:text-gray-500 text-base leading-4 mt-6 text-white poppin text-[14px] cursor-pointer">
                     Status policy
               ...
               <div className="mt-10 lg:block hidden">
                  <label className="text-xl font-medium leading-5 lilita">
                     Get updates
                  </label>
                  <div className="cursor-pointer flex items-center justify-between border border-gray-800 mt-4">
                     <input
                        type="text"
                        className="text-base input rounded-none leading-4 p-4 w-full focus:outline-none text-gray-800 placeholder-gray-800"
                        placeholder="Enter your email"
                     />

                     <button className="btn btn-primary border-0 rounded-none">
                        Submit
                     </button>
                  </div>
               </div>
